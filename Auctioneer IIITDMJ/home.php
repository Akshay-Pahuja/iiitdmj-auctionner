                                 ...
                                 <div class="card">
                                    <div class="float-right align-top bid-tag">
                                     ...
                                     <div class="card-body prod-item">
                                         ...
                                         <p class="truncate"><large><?php echo $row['description'] ?></p>
                                          

                                        <button class="btn btn-primary btn-lg view_prod" type="button" data-id="<?php echo $row['id'] ?>"> View</button>
                                         <p><small>available until:</small></p>
                                            
                                         <span class=" text-black"><i class="fa fa-hourglass-half"></i> <?php echo date("M d,Y h:i A",strtotime($row['bid_end_datetime'])) ?></span>
                                     </div>
                                 </div>
                             </div>
                            <?php endwhile; ?>
